...
import voxelize.perimeter
from voxelize.util import manhattanDistance, removeDupsFromPointList
...
def calculateScaleAndShift(mesh, resolution):
    ...
    xyscale = float(resolution - 1) / (max(maxs[0] - mins[0], maxs[1] - mins[1],maxs[2] - mins[2]))
